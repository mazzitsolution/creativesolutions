...
<head>
    ...
    <meta name="description" content="Travel Mirissa Whale Watching Tours, Book Mirissa Whale Watching Tours, Mirissa Whale Watching Tours in Sri Lanka">
    <meta name="author" content="Developed by MazZIT Solution">
    <meta name="keywords" content="Travel Mirissa Whale Watching Tours, Book Mirissa Whale Watching Tours, Mirissa Whale Watching Tours in Sri Lanka">
    <title><?php echo $MAIN_TITLE; ?> Mirissa Whale Watching Tours</title>
...
<body class="datepicker_mobile_full"><!-- Remove this class to disable datepicker full on mobile -->
	...
	<main>
		<section class="hero_in tours_detail" style="background: url('../img/hero_in_tours_detail_new.jpg') center center no-repeat; background-size: cover;">
			<div class="wrapper">
				<div class="container">
					<h1 class="fadeInUp"><span></span>Mirissa Whale Watching Tour</h1>
				</div>
