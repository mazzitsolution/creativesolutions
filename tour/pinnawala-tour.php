...
<head>
    ...
    <meta name="description" content="Travel Pinnawala Elephant Orphanage Tours, Book Pinnawala Elephant Orphanage Tours, Pinnawala Elephant Orphanage Tours in Sri Lanka">
    <meta name="author" content="Developed by MazZIT Solution">
    <meta name="keywords" content="Travel Pinnawala Elephant Orphanage Tours, Book Pinnawala Elephant Orphanage Tours, Pinnawala Elephant Orphanage Tours in Sri Lanka">
    <title><?php echo $MAIN_TITLE; ?> Pinnawala Elephant Orphanage Tours</title>
...
<body class="datepicker_mobile_full"><!-- Remove this class to disable datepicker full on mobile -->
	...
	<main>
		<section class="hero_in tours_detail" style="background: url('../img/hero_in_tours_detail_new.jpg') center center no-repeat; background-size: cover;">
			<div class="wrapper">
				<div class="container">
					<h1 class="fadeInUp"><span></span>Pinnawala Elephant Orphanage Tour</h1>
				</div>
		...
		<div class="bg_color_1">
			...
			<div class="container margin_60_35">
				<div class="row">
					...
					<!-- /col -->
					<!--========== FOOTER STYLE START ==========-->
					<?php include '../includes/package-details-rhs-bar.php'; ?>
					<!--========== FOOTER STYLE END ==========-->
				</div>
				<!-- /row -->
			</div>
