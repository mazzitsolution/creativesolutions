<div class="footer_style__one bg-center bg-cover bg-no-repeat mt-17 pt-17 bg-fixed overflow-hidden"
        style="background: linear-gradient( rgba(8, 8, 11, .8) 100%, rgba(8, 8, 11, .8)100%), url('assets/images/backgrounds/footer-bg-1.webp')">
        <div class="container">
            <div class="flex lg:justify-between justify-center items-center flex-wrap gap-base pb-base">
                <a href="#">
                    <img src="assets/images/logo_lankanvoyage.png" alt="placeholder">
                </a>
                <div class="flex align-middle justify-center lg:gap-x-9 gap-y-5 gap-x-7 flex-wrap">
                    <a href="https://wa.me/+94772317311" class="inline-flex items-center group">
                        <div class="social_icon_varient__one">
                            <i class="bi bi-whatsapp"></i>
                        </div>
                        <h5 class="text-white lg:text-2md text-md font-serif font-bold">whatsapp </h5>
                    </a>
                    <a href="#" class="inline-flex items-center group">
                        <div class="social_icon_varient__one">
                            <i class="bi bi-twitter"></i>
                        </div>
                        <h5 class="text-white lg:text-2md text-md font-serif font-bold">Twitter</h5>
                    </a>
                    <a href="#" class="inline-flex items-center group">
                        <div class="social_icon_varient__one">
                            <i class="bi bi-pinterest"></i>
                        </div>
                        <h5 class="text-white lg:text-2md text-md font-serif font-bold">Pinterest</h5>
                    </a>
            ...
            <div class="grid lg:grid-cols-12 lg:pt-17 pt-10 gap-base lg:pb-17 pb-12 gradient-border-top">
                <div class="lg:col-span-4 col-span-12 text-center lg:text-start">
                    ...
                    <form action="#" class="mt-5 md:max-w-[345px] max-w-[300px] lg:mx-0 mx-auto">
                        <div class="relative">
                            <input type="text"
                                class="bg-[#0C0F13] bg-transparent h-12 py-3 pr-5 pl-12 outline-none border-stock-1 border border-opacity-40 w-full text-white text-sm placeholder:to-dark-5 focus:border-primary-2"
                                placeholder="Email address">
                            <div class="absolute left-5 max-w-5 top-1/2 -translate-y-1/2">
                ...
                <div
                    ...
                    <div class="flex-grow">
                        <div class="mb-base">
                            <h3 class="text-white lg:text-[25px] text-2md font-semibold lg:leading-1.35">One Day Tours</h3>
                        </div>
                        <ul class="footer-link-list">
                            <li><a class="footer-nav-link" href="galle-tours.php">Galle Day Tour</a></li>
                            <li><a class="footer-nav-link" href="ella-tour.php">Ella Day Tour</a></li>
                            <li><a class="footer-nav-link" href="udawalawa-tour.php">Udawalawe safari Day Tour</a></li>
                            <li><a class="footer-nav-link" href="yaala-tours.php">Yala National Park Day Tour</a></li>
                            <li><a class="footer-nav-link" href="upcoming.php">Kithulgala Water Rafting Day Tour</a></li>
                            <li><a class="footer-nav-link" href="upcoming.php">Sigiriya& Dambulla Day Tour</a></li>
                            <li><a class="footer-nav-link" href="upcoming.php">Kandy Day Tour</a></li>
                            <li><a class="footer-nav-link" href="upcoming.php">Whale watching Tour</a></li>
                            <li><a class="footer-nav-link" href="upcoming.php">Bentota Deep Sea Fishing Day Tour</a></li>
                            <li><a class="footer-nav-link" href="upcoming.php">Sinharaja Day Tour</a></li>
                            <li><a class="footer-nav-link" href="upcoming.php">Pinnawala Elephant Orphanage Day Tour</a></li>
                        </ul>
                    </div>
                    
                    <div class="max-w-[275px] flex-grow shrink-0 ">
                        <div class="mb-base">
                            <h3 class="text-white lg:text-[25px] text-2md font-semibold lg:leading-1.35">Contact Us</h3>
                        </div>
                        ...
                        <ul>
                            <li
                                ...
                                <a href="#" class="leading-1.5 pl-[10px] text-base ">Kottawa, Colombo, Sri Lanka</a>
                            </li>
                            <li
                                ...
                                <a href="tel:+8801236985" class="leading-1.5 pl-[10px] text-base ">+94772317311 / +94717383268</a>
                            </li>
                            <li
                                class="mt-5 first:mt-0 flex items-center lg:justify-start justify-center text-stock-1 hover:text-primary-1 duration-200">
                                <div class="text-primary-1 shrink-0">
                                ...
                                <a href="mailto:example@gmail.com"
                                    class="leading-1.5 pl-[10px] text-base ">info@lankanvoyage.com</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div
                ...
                <!-- <p>Developed by <a href="https://mazzit.com">MazZIT Solution</a> 2025 | All rights reserved.</p> -->
                <p><a href="http://lankanvoyage.com" class="hover:text-primary-1 duration-200">Privacy Policy</a> | <a
                        href="http://lankanvoyage.com" class="hover:text-primary-1 duration-200">Terms of Use</a></p>
            </div>
        </div>
    </div>